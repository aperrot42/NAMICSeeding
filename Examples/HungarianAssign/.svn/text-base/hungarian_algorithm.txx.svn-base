...
#include <iostream>
  ...
  /// multithread
  /// move to protected
  /// set input matrix method to be able to run more than 1 assignement
  //===============================================================//
...
//-----------------------------------------------------------------------------
template<class T>
hungarian_algorithm<T>::
hungarian_algorithm() : m_TotalCost(0)
{
}
...
//-----------------------------------------------------------------------------
template <class T>
typename hungarian_algorithm<T>::STEP_TYPE
hungarian_algorithm<T>::
Step_3()
{
  unsigned count = 0;
...
//-----------------------------------------------------------------------------
template <class T>
typename hungarian_algorithm<T>::AssignmentMatrixType
hungarian_algorithm<T>::
GetAssignmentMatrix()
{
  return m_M;
...
//-----------------------------------------------------------------------------
template <class T>
typename hungarian_algorithm<T>::AssignmentVectorType
hungarian_algorithm<T>::
GetAssignmentVector()
{
